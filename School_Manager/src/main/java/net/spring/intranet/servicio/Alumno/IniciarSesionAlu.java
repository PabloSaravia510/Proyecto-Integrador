...
@XmlRootElement(name = "iniciarSesionAlu")
public class IniciarSesionAlu {

    @XmlElementRef(name = "user", namespace = "http://service.intranet.spring.net", type = JAXBElement.class, required = false)
