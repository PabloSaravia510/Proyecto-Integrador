...
public class ObjectFactory {
    ...
    private final static QName _SaveSeccionBean_QNAME = new QName("http://service.intranet.spring.net", "bean");
    ...
    /**
     * Create an instance of {@link ListaSeccionesxProfesores }
     * 
     */
    public ListaSeccionesxProfesores createListaSeccionesxProfesores() {
        return new ListaSeccionesxProfesores();
    }
    ...
    /**
     * Create an instance of {@link ListaSeccionesxProfesoresResponse }
     * 
     */
    public ListaSeccionesxProfesoresResponse createListaSeccionesxProfesoresResponse() {
        return new ListaSeccionesxProfesoresResponse();
    }
    ...
    public JAXBElement<Seccion> createSaveSeccionBean(Seccion value) {
        return new JAXBElement<Seccion>(_SaveSeccionBean_QNAME, Seccion.class, SaveSeccion.class, value);
    }
    ...
    public JAXBElement<Seccion> createUpdateSeccionBean(Seccion value) {
        return new JAXBElement<Seccion>(_SaveSeccionBean_QNAME, Seccion.class, UpdateSeccion.class, value);
    }
